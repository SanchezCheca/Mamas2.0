...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="pt-5"></div>
            <main>
                <div class="container mt-5 d-flex flex-column border vh-80" >
                    <div class="row">
                        ...
                        <div class="col-md-6 mx-auto">
                            <form action="../Controladores/controladorPrincipal.php" name="formularioPreguntas">
                                ...
                                if (isset($_SESSION['tipopregunta'])) {
                                    ...
                                    <div class="text-center">
                                        <h3>Respuesta</h3>
                                        <textarea id="resp" name="respu" rows="5" class="w-100"></textarea>
                                    </div>
                                    <?php
                                }
                                ?>
                                <div class="row w-100 mx-auto">
                                    <input type="number" name="valor" class="col-md-4 ml-auto" placeholder="Puntuación"> 
                                </div>
                                
                                <div class="text-center mt-3">
                                    <button type="submit" name="anadirPregunta" class="btn blue-gradient w-100">Añadir pregunta</button>
                                </div>
                            </form>
                        </div>
                    </div>
